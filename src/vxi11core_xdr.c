	...
	if (xdrs->x_op == XDR_ENCODE) {
		...
		if (buf == NULL) {
			 ...
			 if (!xdr_bool (xdrs, &objp->lockDevice))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->lock_timeout))
				 return FALSE;
...
xdr_Create_LinkResp (XDR *xdrs, Create_LinkResp *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_u_short (xdrs, &objp->abortPort))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->maxRecvSize))
		 return FALSE;
	return TRUE;
}
...
xdr_Device_WriteParms (XDR *xdrs, Device_WriteParms *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_Device_Link (xdrs, &objp->lid))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->io_timeout))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->lock_timeout))
		 return FALSE;
...
xdr_Device_ReadParms (XDR *xdrs, Device_ReadParms *objp)
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		...
		buf = XDR_INLINE (xdrs, 3 * BYTES_PER_XDR_UNIT);
		if (buf == NULL) {
			 if (!xdr_u_int (xdrs, &objp->requestSize))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->io_timeout))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->lock_timeout))
...
xdr_Device_RemoteFunc (XDR *xdrs, Device_RemoteFunc *objp)
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		...
		if (buf == NULL) {
			 if (!xdr_u_int (xdrs, &objp->hostAddr))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->hostPort))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->progNum))
				 return FALSE;
			 if (!xdr_u_int (xdrs, &objp->progVers))
				 return FALSE;
